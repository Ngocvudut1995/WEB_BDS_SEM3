...
app.controller('postCtrl', ['$scope', '$http', '$rootScope', '$routeParams', function ($scope, $http, $rootScope, $routeParams) {
    ...
    $scope.uploadFiles = function (idvp) {

        var request = {
            method: 'POST',
            url: host + '/api/post/UploadFiles/?id=' + idvp,
            data: formdata,
            headers: {
    ...
    $http.get(host + "/api/TimKiem/get_DanhMuc_By_Sell").then(function (response) {
        $scope.list_DM = response.data;
